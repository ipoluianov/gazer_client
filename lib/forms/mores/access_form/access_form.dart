...
class AccessForm extends StatefulWidget {
  final AccessFormArgument arg;
  const AccessForm(this.arg, {Key? key}) : super(key: key);
...
class AccessFormSt extends State<AccessForm> {
  @override
  void initState() {
    super.initState();
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Column(children: [
                                    ...
                                    Text(
                                      widget.arg.connection.sessionKey,
                                      style: const TextStyle(
                                          fontSize: 16,
                                          color: Colors.green,
                                          fontFamily: "RobotoMono"),
