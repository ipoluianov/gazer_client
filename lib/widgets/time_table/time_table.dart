...
import 'package:gazer_client/widgets/time_table/time_table_painter.dart';
...
class TimeTableState extends State<TimeTable> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _scrollController.addListener(() {
      setState(() {
        widget._settings.scrollOffset = _scrollController.offset;
      });
    });
    requestHistory();
                        ...
                        child: ListView(
                          ...
                          children: [
                            CustomPaint(
                              ...
                              child: Container(
                                height: widget._settings.calcHeight(),
                              ),
                              key: UniqueKey(),
                            )
                          ],
